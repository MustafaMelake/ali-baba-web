    ...
    <div className="min-h-screen w-full bg-[#FAFAFA] lg:grid lg:grid-cols-2">
      ...
      <section className="flex items-center justify-center px-6 py-16 sm:px-10 md:py-20">
        <div className="w-full max-w-md">
          ...
          {/* Toggle to signup — carries the redirect intent along, so a user
              bounced here by the proxy who registers instead of signing in
              still lands on the page they originally wanted. */}
          <motion.p
