...
import { deleteBranch } from "@/lib/actions/manage-branches";

/**
 * Icon button that expands into an inline "Are you sure?" confirmation before
 * deleting. The server action refuses (with a clear message) if managers are
 * still assigned, so the destructive path is safe.
 */
